...
export default class Cart {
  ...
  addModalBodyEventListeners = (modalBody) => {
  ...
  renderModalBody = () => {
    ...
    modalBody.append(this.renderOrderModal());
    this.addModalBodyEventListeners(modalBody);
    return modalBody;
  };
  ...
  onProductUpdate = (cartItem) => {
    ...
    if (bodyOpen) {
      ...
      let productCount = this.modal.element.querySelector(
        `[data-product-id="${productID}"] .cart-counter__count`
      );
      productCount.innerHTML = cartItem.count;

      let productPrice = this.modal.element.querySelector(
      ...
      let infoPrice = this.modal.element.querySelector(
